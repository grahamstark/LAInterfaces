...
#### FRS 
FRS asset figures are for financial assets only and are recorded 
...
FRS has no physical capital variables and no measure of net debt.
...
FRS Hybrid Method:
    Mean:           174130.856968
    Std. Deviation: 1180353.308364
    Minimum:        0.000499
    1st Quartile:   3490.211230
    Median:         17906.699082
    3rd Quartile:   82892.751084
    Maximum:        74536124.513276
...
ax = Axis(fl[1,1]; 
    ...
    xtickformat="{:.1f}")
# colo[u]rs: http://juliagraphics.github.io/Colors.jl/stable/namedcolors/
c1 = density!(ax,log.(cap[0 .< cap.cap_other_method_1 .<= 250_000,:cap_other_method_1]), color = (:blue, 0.4))
c2 = density!(ax,log.(cap[0 .< cap.cap_no_method .<= 250_000,:cap_no_method]), color = (:deeppink, 0.4))
c3 = density!(ax,log.(cap[0 .< cap.cap_imputation .<= 250_000,:cap_imputation]), color=(:green,0.4))
Legend(fl[1, 2],[c1,c2,c3], ["Hybrid Method", "Raw FRS", "WAS Imputation"])
