...
Julia code is organised into `modules` [] which are aggregated into packages [] which can be downloaded and either run directly or integrated into other programs. For this project, several modules were added to the Scotben package:
