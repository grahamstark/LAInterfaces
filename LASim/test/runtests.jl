...
# !!! Main.UserApp is configured as an alias for Main.LASim and you might encounter it in some tests
using Main.LASim, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "LASim tests" begin
  @includetests ARGS
end
