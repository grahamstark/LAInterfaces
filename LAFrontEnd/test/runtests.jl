...
# !!! Main.UserApp is configured as an alias for Main.LAFrontEnd and you might encounter it in some tests
using Main.LAFrontEnd, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "LAFrontEnd tests" begin
  @includetests ARGS
end
